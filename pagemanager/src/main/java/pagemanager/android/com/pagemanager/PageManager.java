...
public class PageManager {
    ...
    public static int BASE_LOADING_LAYOUT_ID = R.layout.pager_empty;
    ...
    public static PageManager init(final Object container, final String loadingMessage, final Runnable retryAction) {
        PageManager manager = generate(container, new PageListener() {
            @Override
            public void setRetryEvent(View retryView) {
                retryView.setOnClickListener(new View.OnClickListener() {
